...
replace_once("define( 'CTL_VERSION', '1.0.0' );", "define( 'CTL_VERSION', '1.0.1' );")
...
replace_once("\t\t\tesc_attr( $s['access_token'] ),", "\t\t\t'',")
replace_once("\t\t\t\t'enable_debug'       => true,", "\t\t\t\t'enable_debug'       => false,")
...
'''
replace_once(anchor, helpers + anchor)
